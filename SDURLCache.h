 ...
 * The default value is YES when running under iOS >= 4.2, and NO under older iOS versions.
 */
@property (nonatomic, assign) BOOL allowDiskCachingOfMemoryOnlyResponses;
